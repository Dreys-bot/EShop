...
(function() {
  var HMACSigner, HMACVerifier, JwaAlgorithm, NONE_SIGNER, NoneSigner, NoneVerifier, RSSigner, RSVerifier, crypto, ju, jwa_provider, jwa_table, jwa_verifier, newHMACSigner, newHMACVerifier, newNoneSigner, newNoneVerifier, newRSSigner, newRSVerifier,
  ...
  NoneSigner = (function(_super) {
    ...
    function NoneSigner() {
      return NoneSigner.__super__.constructor.apply(this, arguments);
    }
  ...
  NoneVerifier = (function(_super) {
    ...
    function NoneVerifier() {
      return NoneVerifier.__super__.constructor.apply(this, arguments);
    }

    NoneVerifier.prototype.alg = "NONE";

    NoneVerifier.prototype.verify = function(jwt_req) {
      var jwt_claim, jwt_enc_sig, jwt_header, _ref;
      jwt_header = jwt_req != null ? jwt_req.header : void 0;
      jwt_claim = jwt_req != null ? jwt_req.claim : void 0;
      jwt_enc_sig = jwt_req != null ? (_ref = jwt_req.segments) != null ? _ref[2] : void 0 : void 0;
  ...
  HMACVerifier = (function(_super) {
    ...
    function HMACVerifier() {
      return HMACVerifier.__super__.constructor.apply(this, arguments);
    }

    HMACVerifier.prototype.alg = "HMAC";

    HMACVerifier.prototype.verify = function(jwt_req, key) {
      var algImpl, signer, _actual_sign, _alg, _claim, _enc_sig, _ref, _ref1, _ref2, _ref3, _ref4, _typ;
      if (!jwt_req) {
      ...
      _typ = jwt_req != null ? (_ref = jwt_req.header) != null ? _ref.typ : void 0 : void 0;
      _alg = jwt_req != null ? (_ref1 = jwt_req.header) != null ? _ref1.alg : void 0 : void 0;
      _claim = jwt_req != null ? jwt_req.claim : void 0;
      _enc_sig = jwt_req != null ? (_ref2 = jwt_req.segments) != null ? _ref2[2] : void 0 : void 0;
      if (_typ !== "JWT") {
        return false;
      }
      if (!this.hash(_alg)) {
      ...
      signer = algImpl(key);
      signer.update("" + ((_ref3 = jwt_req.segments) != null ? _ref3[0] : void 0) + "." + ((_ref4 = jwt_req.segments) != null ? _ref4[1] : void 0));
  ...
  RSVerifier = (function(_super) {
    ...
    function RSVerifier() {
      return RSVerifier.__super__.constructor.apply(this, arguments);
    }
    ...
    RSVerifier.prototype.verify = function(jwt_req, public_key) {
      var openSSL, _alg, _claim, _enc_sig, _ref, _ref1, _ref2, _sig, _typ, _verifier;
      if (!jwt_req) {
        throw new Error("jwt request not specified");
      }
      if (!public_key) {
