...
(function() {
  ...
  module.exports.encode = function(claim, key, algorithm) {
    var header, jwa_provider, jwa_signer, segments;
    if (algorithm == null) {
      algorithm = "HS256";
    }
  ...
  JwtRequest = (function() {
    ...
    function JwtRequest(header, claim, segments) {
      ...
      if (this.header.typ !== 'JWT') {
        throw new Error("Unable to read `typ` form header or it doesn't match the expected 'JWT' value ");
      }
    }
